            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var l = f.getFbeventsModules("SignalsFBEventsOptIn"),
                        ...
                        n = f.getFbeventsModules("signalsFBEventsGetIsIosInAppBrowser"),
                        o = f.getFbeventsModules("SignalsFBEventsURLUtil"),
                        p = o.getURLParameter,
                        q = f.getFbeventsModules("SignalsFBEventsGetValidUrl"),
                        r = f.getFbeventsModules("SignalsFBEventsResolveLink");
                    o = f.getFbeventsModules("SignalsPixelCookieUtils");
                    var s = o.CLICK_ID_PARAMETER,
                        t = o.readPackedCookie,
                        u = o.CLICKTHROUGH_COOKIE_NAME;
                    o = f.getFbeventsModules("SignalsFBEventsExperimentNames");
                    var x = o.USE_FBC_AS_CACHE_KEY_EXPERIMENT,
                    ...
                    var F = o.registerAsyncParamAllSettledListener,
                        G = o.flushAsyncParamEventQueue,
                        H = m.each,
                        I = m.keys,
                        J = m.map,
                        K = m.some,
                    ...
                    var ca = function(a, b, c, d, e, f) {
                        ...
                        f != null && n() && e != "" && g.append("fbc", f);
                        B.addEncodings(g);
                        return "".concat(j.CONFIG.CDN_BASE_URL, "signals/config/").concat(a, "?").concat(g.toQueryString())
                    };

                    function da(a, b, c, d, e, f) {
                        j.loadJSFile(ca(a, b, c, e, d, f))
                    }
                    m = function() {
                        function c(a, d) {
                            var g = this;
                            w(this, c);
                            z(this, "VALID_FEATURES", N);
                            z(this, "optIns", new l(Q));
                        ...
                        return y(c, [{
                            ...
                            value: function(a, b) {
                                ...
                                if (typeof b !== "string" || !ba(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                                ba(b) && (this.optIns.optIn(a, b, d), H([b].concat(C(Q[b] || [])), function(a) {
                                    R[a] && H(R[a], function(a) {
                            ...
                            value: function(b, c, d, e) {
                                ...
                                return this.trackSingleGeneric(b, c, d, O.TrackSingle, e)
                            }
                        }, {
                            ...
                            value: function(a, b, c, d, e, f) {
                                return this.trackSingleGeneric(b, c, d, O.TrackSingleSystem, e || null, a, f)
                            }
                        }, {
                            ...
                            value: function(a, b, c, d, e, f, g) {
                                ...
                                if (!Object.prototype.hasOwnProperty.call(this.pixelsByID, a)) {
                                    ...
                                    f == null ? M(h) : L(new Error(h.type + " " + h.pixelID));
                                    return this
                                }
                            ...
                            value: function() {
                                if (!A.isInTest(x) || n() === !1) return "";
                                var a = p(g.location.href, s);
                                (a == null || a.trim() == "") && (a = p(h.referrer, s));
                            ...
                            value: function(a) {
                                ...
                                a !== P && (F(this), this.disableAsyncParamBackupTimeout || setTimeout(function() {
                                    G(b)
                                }, aa))
                            }
                        }])
                ...
                (function() {
                    j.exports = function(a) {
                        ...
                        var oc = {
                            ...
                            zc = k.filter(Ja.split(Ia), function(a) {
                                return "a" !== a
                            }).join(Ia),
                            Ac = function a(b, c, d) {
                        ...
                        function fd() {
                            var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                ...
                                m = k.localProductID,
                                l = k.SKU;
                            id(i, m, l), null == j.contents && (j.contents = []), j.contents.push(h), qd(i.automaticParameters, a, j.contents);
                            var n = jd(e);
                            return {
                                    ...
                                    for (var l = {}, s = k.querySelectorAll("[itemprop]"), m = 0; m < s.length; m++) {
                                        ...
                                        if (!c.has(t)) {
                                            ...
                                            if ("string" == typeof n && "" !== n) {
                                                ...
                                                if (null != t && "" !== t) {
                                                    var o = l[n];
                                                    null != o && Yc(r, n) ? Array.isArray(o) ? l[n].push(t) : l[n] = [o, t] : (null == e.productID && ("productID" === n ? p = t : "sku" === n && (j = t)), null == e.productUrl && "url" === n && (e.productUrl = t), a && null == e.pdpData.description && "description" === n && (e.pdpData.description = t), g && (null == e.automaticParameters.currency && "priceCurrency" === n && (e.automaticParameters.currency = t), null != f.id || "productID" !== n && "sku" !== n || (f.id = t), null == f.mpn && "mpn" === n && (f.mpn = t), null == f.gtin && (h ? ["gtin"] : Y).includes(n) && (f.gtin = t), null == f.item_price && "price" === n && Z(f, "item_price", rd(t, h)), null == f.availability && "availability" === n && (f.availability = xd(t))), l[n] = t)
                                                }
                                            }
                                        }
                                    }
                        ...
                        function kd(a, b) {
                            ...
                            var d = {},
                                ...
                                f = $(a, Oc, b.mpn),
                                g = $(a, Y, b.gtin);
                            c && (f = b.mpn, g = b.gtin), Z(d, "mpn", f), Z(d, "gtin", g), Z(d, "item_price", e.price), Z(d, "availability", xd($(a, Rc)));
                            var h = b.id ? [b.id] : [],
                                i = c ? h : sd(a, Uc, b.id),
                                j = dd(d, i);
                            return {
                        ...
                        function md() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], c = arguments.length > 2 ? arguments[2] : void 0, d = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], e = {
                                    ...
                                    productUrl: null,
                                    pdpData: {}
                                }, f = [], h = [], i = g.querySelectorAll('script[type="application/ld+json"]'), j = 0, k = [], o = 0; o < i.length; o++) {
                                var l = i[o],
                                    p = l.innerText;
                                if (null != p && "" !== p) try {
                                    if ((j += p.length) > 12e4) return qd(e.automaticParameters, a, k), {
                                    ...
                                    var m = null;
                                    b ? m = JSON.parse(p.replace(/[\n\r\t]+/g, " ")) : (m = Ad(p), m = JSON.parse(m.replace(/[\n\r\t]+/g, " "))), Array.isArray(m) || (m = [m]);
                                    for (var q = function() {
                                            var g = m[n];
                                            b || (nd(m, $(g, ["mainentity"])), nd(m, $(g, ["@graph"])), nd(m, $(g, ["hasvariant"])));
                                            var h = pd(g),
                                                i = Lc.includes(h),
                                                l = {};
                                            if (i) {
                                                var j = $(g, Uc);
                                                if (null != e.productID && "" !== e.productID || (e.productID = j), d) {
                                                    var o = $(g, Pc);
                                                    null != o && (e.pdpData.name = o);
                                                    o = $(g, Qc);
                                                    null != o && (e.pdpData.description = o)
                                                }
                                                a && (Z(l, "id", j), Z(l, "mpn", $(g, Oc)), ld(g, c), Z(l, "gtin", $(g, b ? ["gtin"] : Y)))
                                            }(null == e.productUrl || "" === e.productUrl || i) && g.url && (e.productUrl = g.url);
                                            o = $(g, Vc);
                                            if ((null == e.productUrl || i) && null != o)
                                                if (Array.isArray(o) && o.length > 0) Gc(o, function(d) {
                                                    if (null == e.productUrl && d.url && (e.productUrl = d.url), a) {
                                                        var f = kd(d, l, b);
                                                        ld(d, c), null == e.automaticParameters.currency && (e.automaticParameters.currency = f.currency), k = k.concat(f.content)
                                                    }
                                                });
                                                else {
                                                    h = pd(o);
                                                    j = Mc.includes(h);
                                                    i = Nc.includes(h);
                                                    if (null == e.productUrl && j && o.url && (e.productUrl = o.url), (j || i) && a) {
                                                        h = kd(o, l, b);
                                                        ld(o, c), null == e.automaticParameters.currency && (e.automaticParameters.currency = h.currency), k = k.concat(h.content)
                                                    }
                                                }
                                            f.push(g)
                                        }, n = 0; n < m.length; n++) q()
                            ...
                            return qd(e.automaticParameters, a, k), {
                                extractedProperties: f,
                                invalidInnerTexts: h,
                                productMetadata: e
                            }
                        ...
                        function od(a, b) {
                            ...
                            if (null == a) return c;
                            if (c.price = rd($(a, Sc), b), c.currency = $(a, Tc), b) return c;
                            b = function(a) {
                                var b = {
                                    price: null,
                                    currency: null
                                ...
                                if (null == a) return b;
                                if (!Array.isArray(a)) return b.price = rd($(a, Sc)), b.currency = $(a, Tc), b;
                        ...
                        function td(a, b, c) {
                            null != c.pdpData.description || "product:description" !== a && "og:description" !== a || (c.pdpData.description = b)
                        }
                        ...
                        function ud(a, b, c, d, e) {
                            ...
                            }).includes(a) && (d.gtin = b), null != d.item_price || "product:price:amount" !== a && "og:price:amount" !== a || Z(d, "item_price", rd(b, e)), null != d.availability || "product:availability" !== a && "og:availability" !== a || (d.availability = xd(b))
                        }
                        ...
                        function vd(a, b, c, d, e, f, g) {
                            var h = arguments.length > 7 && void 0 !== arguments[7] && arguments[7],
                                ...
                                j = null,
                                k = c[a];
                            return null != k && Xc(a) ? Array.isArray(k) ? c[a].push(b) : c[a] = [k, b] : (b && (null != d.productID && "" !== d.productID || ("product:retailer_item_id" === a && (i = b), "product:sku" === a && (j = b)), null != d.productUrl && "" !== d.productUrl || "og:url" !== a || (d.productUrl = b), h && td(a, b, d), f && ud(a, b, d, e)), c[a] = b), {
                        ...
                        function wd() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], c = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], d = {
                                ...
                                if ("string" == typeof p && -1 !== p.indexOf(":") && "string" == typeof m && e.has(p.split(":")[0])) {
                                    var q = T(m, 500),
                                        n = vd(p, q, f, d, j, a, b, c);
                                    n.productRetailerItemID && (h = n.productRetailerItemID), n.productSKU && (i = n.productSKU)
                                }
                            }
                            return null != h ? d.productID = h : null != i && (d.productID = i), qd(d.automaticParameters, a, [j]), {
                                extractedProperties: f,
                                productMetadata: d
                            }
                        }
                        ...
                        function zd() {
                            ...
                            for (var d = g.querySelectorAll("meta[name]"), e = 0; e < d.length; e++) {
                                ...
                                "string" == typeof h && "string" == typeof i && yd[h] && (c["meta:" + h] = T(i, 500))
                            }
                            return c
                        }
                ...
                (function() {
                    ...
                    function Ba(b, c, e) {
                        var f = this,
                            ...
                            j = null;
                        if (this == null) {
                            var k = O.getAssignmentFor("fix_null_context_passed");
                            k === O.TEST ? (h = !0, f = new ua({
                                allowDuplicatePageViews: !0,
                                isAutomaticPageView: !0
                            }), j = new d(a.piiTranslator), j.append("ie[a]", "1")) : k === O.CONTROL && O.clearExposure()
                        }
                        try {
