...
window[window["TiktokAnalyticsObject"]]._variation_id = 'traffic_2::default';
window[window["TiktokAnalyticsObject"]]._vids = '74169685,74169794,74172070';
window[window["TiktokAnalyticsObject"]]._cc = 'PK';
window[window.TiktokAnalyticsObject]._li || (window[window.TiktokAnalyticsObject]._li = {}), window[window.TiktokAnalyticsObject]._li["CR6TKMJC77UBVEOEGQ20"] = "49a560bd-74da-11f0-b8e9-000017016b9e";
window[window["TiktokAnalyticsObject"]]._cde = 390;;
if (!window[window["TiktokAnalyticsObject"]]._server_unique_id) window[window["TiktokAnalyticsObject"]]._server_unique_id = '49a5a247-74da-11f0-b8e9-000017016b9e';
...
! function(e, n, i, d, o, t) {
    var u, a, c = g()._static_map || [{
        ...
        e = (g()._static_map = c, a = "https://analytics.tiktok.com/i18n/pixel/static/", null == (e = u = {
            "info": {
                "pixelCode": "CR6TKMJC77UBVEOEGQ20",
                "name": "University of Sheffield",
                "status": 0,
                "setupMode": 0,
                "partner": "",
                "advertiserID": "7407778587786641425",
                "is_onsite": false,
    ...
    n || (n = [], window && (window[l()] = n)), Object.assign(u, {
        options: r(e, "_o")
    }), v = u, n._i || (n._i = {}), (A = v.info.pixelCode) && (n._i[A] || (n._i[A] = []), Object.assign(n._i[A], v), n._i[A]._load = +new Date), Object.assign(u.info, {
        loadStart: r(e, "_t"),
        ...
        return n ? "".concat(e, "main.").concat(n.id, ".js") : "".concat(e, "main.").concat(c[0].id, ".js")
    }(n._plugins, u.plugins, a), A = e, (void 0 !== self.DedicatedWorkerGlobalScope ? self instanceof self.DedicatedWorkerGlobalScope : "DedicatedWorkerGlobalScope" === self.constructor.name) ? self.importScripts && self.importScripts(v) : ((i = document.createElement("script")).type = "text/javascript", i.async = !0, i.src = v, i.setAttribute("data-id", A), (v = document.getElementsByTagName("script")[0]) && v.parentNode && v.parentNode.insertBefore(i, v))
}();